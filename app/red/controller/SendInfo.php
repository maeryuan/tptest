...
class SendInfo extends Controller {
    ...
    /**
     * 
     * @param type $data 要发送的数据
     * @param type $exchangeName 交换机名字
     * @param type $queueName  队列名字
     * @param type $routingKey routkey值
     */
    public function send($data,$exchangeName = 'test_p_wei_ex',$queueName = 'test_p_wei_q',$routingKey = 'test_p_wei') {
